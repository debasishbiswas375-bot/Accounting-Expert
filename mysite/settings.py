...
import dj_database_url  # if you use PostgreSQL on Render
...
# Database: default to SQLite, but can use PostgreSQL on Render
...
# settings.py
# Tell Django to trust the secure connection from Render
